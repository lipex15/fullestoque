...
const exePath = path.join(__dirname, 'dist-electron', `Global Stock by deathzin Setup ${version}.exe`);
...
async function upload() {
    ...
    // Exact name generated by electron-builder in latest.yml
    const fileName = `Global-Stock-by-deathzin-Setup-${version}.exe`;
